...
#define CONTROL_SELECT_PID 0
#define	CONTROL_SELECT_CASCADE 1
#define CONTROL_SELECT_LEADPHASE 2
...
double Control_refresh(double theta_target, double theta_measure, double theta_dot_measure);
