...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC2     ------> ADC1_IN12
    */
    HAL_GPIO_DeInit(GPIOC, FA_PotArm_Pin|FA_PotBox_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(FA_SDA_IMU_GPIO_Port, FA_SDA_IMU_Pin);

    HAL_GPIO_DeInit(FA_SCL_IMU_GPIO_Port, FA_SCL_IMU_Pin);
